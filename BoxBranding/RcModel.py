...
class RcModel:
	...
	def getRcFolder(self):
		...
		if os.path.exists('/proc/stb/info/azmodel'):
			...
			remotefolder = 'evo7'
		elif boxtype in ('bre2ze','bre2ze4k'):
			remotefolder = 'wwio1'
		...
		elif boxtype in ('zgemmahs', 'zgemmah2s', 'zgemmah2h','zgemmah5','zgemmah52s' ):
			remotefolder = 'zgemma3'
		elif boxtype in ('zgemmai55'):
			remotefolder = 'zgemma5'
		elif boxtype in ('gbuhdquad', 'gbquad', 'gb800se', 'gb800ue', 'gb800solo', 'gb800seplus', 'gb800ueplus', 'gbipbox', 'gbultrase', 'gbultraue', 'gbultraueh', 'gbx1', 'gbx3', 'gbx3h', 'gbx2'):
			remotefolder = 'gb0'
		elif boxtype == 'gbquadplus':
			remotefolder = 'gb1'
		elif boxtype in ('mutant11', 'mutant1100', 'mutant1200', 'mutant530c', 'mutant500c', 'vizyonvita', 'mutant1265', 'mutant1500', 'mutant51', 'bcm7251s'):
			remotefolder = 'hd1100'
			...
			remotefolder = 'dmm1'
		elif boxtype in ('dm7080', 'dm7020hd', 'dm7020hdv2', 'dm800sev2', 'dm500hdv2', 'dm820', 'dm520', 'dm525'):
			remotefolder = 'dmm2'
