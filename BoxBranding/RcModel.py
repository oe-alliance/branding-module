...
class RcModel:
	...
	def getRcFolder(self):
		...
		if os.path.exists('/proc/stb/info/azmodel'):
		...
		elif boxtype in ('zgemmah4','zgemmahs', 'zgemmah2s', 'zgemmah2h','zgemmah5','zgemmah52s','zgemmah3ac','zgemmah5ac','zgemmah52tc','zgemmah32tc','zgemmah7','zgemmah7s','zgemmah7c','zgemmah52splus', 'zgemmah2splus'):
			...
			remotefolder = 'ini5'
		elif boxtype in ('beyonwizt2', 'beyonwizt4', 'beyonwizu4'):
			remotefolder = 'ini7'
