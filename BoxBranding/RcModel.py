...
class RcModel:
	...
	def getRcFolder(self):
		...
		if os.path.exists('/proc/stb/info/azmodel'):
		...
		elif boxtype in ('zgemmahs', 'zgemmah2s', 'zgemmah2h','zgemmah5','zgemmah52s','zgemmah3ac','zgemmah5ac','zgemmah52tc','zgemmah32tc','zgemmah7','zgemmah52splus', 'zgemmah2splus'):
			...
			remotefolder = 'gb1'
		elif boxtype in ('gbquad4k', 'gbx3h', 'gbultraueh'):
			remotefolder = 'gb2'
			...
			remotefolder = 'xcore2'
		elif boxtype in ('spycat','spycatmini','spycatminiplus','spycat4kmini'):
			remotefolder = 'xcore1'
