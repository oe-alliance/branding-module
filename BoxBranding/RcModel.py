...
class RcModel:
	...
	def getRcFolder(self):
		...
		if os.path.exists('/proc/stb/info/azmodel'):
			...
			remotefolder = 'sf108'
		elif boxtype in ('sf3038','sf128','sf138'):
			remotefolder = 'sf3038'
		...
		elif boxtype in ('zgemmahs', 'zgemmah2s', 'zgemmah2h','zgemmah5' ):
			...
			remotefolder = 'gb1'
		elif boxtype in ('mutant11', 'mutant1100', 'mutant1200', 'mutant530c', 'mutant500c', 'vizyonvita', 'mutant1265', 'mutant1500', 'mutant51'):
			remotefolder = 'hd1100'
		...
		elif boxtype in ('iqonios100hd', 'iqonios200hd', 'iqonios300hd', 'iqonios300hdv2', 'roxxs200hd', 'mediaart200hd', 'force2se', 'force2', 'force2plus', 'force2plushv'):
			remotefolder = 'iqon1'
		elif boxtype in ('force1', 'force1plus', 'worldvisionf1', 'worldvisionf1plus'):
			remotefolder = 'iqon2'
		elif boxtype in ('formuler1', 'formuler3', 'formuler4', 'formuler4-turbo'):
			...
			remotefolder = 'dmm1'
		elif boxtype in ('dm7080', 'dm7020hd', 'dm7020hdv2', 'dm800sev2', 'dm500hdv2', 'dm820', 'dm520'):
			remotefolder = 'dmm2'
			...
			remotefolder = 'tm3'
		elif boxtype in ('tmnanosem2', 'tmnanoseplus'):
			remotefolder = 'tm4'
		...
		elif boxtype in ('vusolo', 'vusolo2', 'vusolose', 'vuduo', 'vuuno', 'vuzero', 'vusolo4k'):
			remotefolder = 'vu'
			...
			remotefolder = 'xcore1'
		elif boxtype in ('osmini', 'osminiplus'):
			remotefolder = 'xcore3'
